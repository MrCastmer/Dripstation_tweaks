...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(1) //station general
			return list(ACCESS_KITCHEN, ACCESS_BAR, ACCESS_HYDROPONICS, ACCESS_JANITOR, ACCESS_CHAPEL_OFFICE, ACCESS_CREMATORIUM, ACCESS_LIBRARY, ACCESS_THEATRE, ACCESS_MANUFACTURING, ACCESS_MIME, ACCESS_CLOWN)
		if(2) //security
