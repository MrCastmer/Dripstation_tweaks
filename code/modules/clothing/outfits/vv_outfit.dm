...
/mob/living/carbon/human/proc/copy_outfit()
	...
	var/list/slots_to_check = list(SLOT_W_UNIFORM,SLOT_BACK,SLOT_WEAR_SUIT,SLOT_BELT,SLOT_GLOVES,SLOT_SHOES,SLOT_HEAD,SLOT_WEAR_MASK,SLOT_NECK,SLOT_EARS,SLOT_GLASSES,SLOT_WEAR_ID,SLOT_WEAR_PDA,SLOT_S_STORE,SLOT_L_STORE,SLOT_R_STORE)
