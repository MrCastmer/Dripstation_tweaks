...
#define JOB_DISPLAY_ORDER_EXPLORER 46
#define JOB_DISPLAY_ORDER_SECURITY_CONSULTANT 47
#define JOB_DISPLAY_ORDER_BRIDGE_ASSISTANT 48
#define JOB_DISPLAY_ORDER_CORRECTIONS_OFFICER 49
