...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_ERT = FREQ_ERT,
	RADIO_CHANNEL_SPECOPS = FREQ_SPECOPS,
	RADIO_CHANNEL_LAW = FREQ_LAW,
	RADIO_CHANNEL_SYNDICATE = FREQ_SYNDICATE,
	RADIO_CHANNEL_SYNDTEAM = FREQ_SYNDTEAM,
	RADIO_CHANNEL_TAIPAN = FREQ_TAIPAN,
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_ERT]" = RADIO_CHANNEL_ERT,
	"[FREQ_SPECOPS]" = RADIO_CHANNEL_SPECOPS,
	"[FREQ_LAW]" = RADIO_CHANNEL_LAW,
	"[FREQ_SYNDICATE]" = RADIO_CHANNEL_SYNDICATE,
	"[FREQ_SYNDTEAM]" = RADIO_CHANNEL_SYNDTEAM,
	"[FREQ_TAIPAN]" = RADIO_CHANNEL_TAIPAN,
