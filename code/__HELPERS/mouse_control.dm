/proc/mouse_angle_from_client(client/client)
	...
	*/
	var/list/modifiers = params2list(client.mouseParams)	//Dripstation edit
	if(LAZYACCESS(modifiers, SCREEN_LOC) && client)	//Dripstation edit
		var/list/screen_loc_params = splittext(LAZYACCESS(modifiers, SCREEN_LOC), ",")	//Dripstation edit
...
/proc/mouse_absolute_datum_map_position_from_client(client/client)
	...
	*/
	if(LAZYACCESS(modifiers, SCREEN_LOC))	//Dripstation edit
		var/x = 0
		var/y = 0
		var/z = 0
		var/p_x = 0
