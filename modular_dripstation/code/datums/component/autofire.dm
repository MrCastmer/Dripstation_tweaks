...
/datum/component/automatic_fire/proc/autofire_off(datum/source)
	...
	UnregisterSignal(parent, list(COMSIG_QDELETING, COMSIG_ITEM_DROPPED))	//dripstation edit COMSIG_QDELETING check for bugs
	shooter = null
...
/datum/component/automatic_fire/proc/start_autofiring()
	...
	clicker.mouse_override_icon = 'modular_dripstation/icons/effects/weapon_pointer.dmi'
