/obj/item/shield/riot
	icon = 'modular_dripstation/icons/obj/weapons/shields.dmi'
	mob_overlay_icon = 'modular_dripstation/icons/mob/clothing/back.dmi'
	lefthand_file = 'modular_dripstation/icons/mob/inhands/equipment/shields_lefthand.dmi'
	righthand_file = 'modular_dripstation/icons/mob/inhands/equipment/shields_righthand.dmi'
