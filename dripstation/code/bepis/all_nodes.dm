...
///datum/techweb_node/extreme_office //fuck it, just fuck it
//	id = "extreme_office"
...
//	prereq_ids = list("base")
//	design_ids = list("mauna_mug", "rolling_table")
//	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
//	hidden = TRUE
//	experimental = TRUE
...
///datum/techweb_node/sticky_advanced //until someone fixes the tape code
//	id = "sticky_advanced"
//	display_name = "Advanced Sticky Technology"
//	description = "Taking a good joke too far? Nonsense!"
//	design_ids = list("pointy_tape", "super_sticky_tape")
//	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
//	hidden = TRUE
//	experimental = TRUE
