...
/datum/uplink_item/nt/ball_weps/revolver
	name = ".357 Revolver"
	desc = "A brutally Nanotrasen revolver that fires .357 Magnum rounds and has 7 chambers. This one previously was supposed to be in possession of the high ranking security officers."
...
/datum/uplink_item/nt/ammo/revolver
	name = ".357 Speed Loader Box"
	desc = "A box with two .357 speed loaders. These speed loaders contain seven .357 rounds each; usable with the Mateba revolver."
	item = /obj/item/storage/box/syndie_kit/revolverammo
	cost = 1
	required_ert_uplink = null

/datum/uplink_item/nt/ammo/revolver/ironfeather
	name = ".357 Ironfeather Speed Loader Box"
	desc = "A box with two .357 Ironfeather speed loaders. These speed loaders contain seven .357 Ironfeather shells; usable with the Mateba revolver. \
			Ironfeather shells contain six pellets which are less damaging than buckshot but mildly better over range."
	item = /obj/item/storage/box/syndie_kit/revolvershotgunammo

/datum/uplink_item/nt/ammo/revolver/nutcracker
	name = ".357 Nutcracker Speed Loader"
	desc = "A speed loader that contains seven .357 Nutcracker rounds; usable with the Mateba revolver. \
			These rounds lose moderate stopping power in exchange for being able to rapidly destroy doors and windows."
	item = /obj/item/ammo_box/a357/nutcracker

/datum/uplink_item/nt/ammo/revolver/metalshock
	name = ".357 Metalshock Speed Loader"
	desc = "A speed loader that contains seven .357 Metalshock rounds; usable with the Mateba revolver. \
			These rounds convert some lethality into an electric payload, which can bounce between targets."
	item = /obj/item/ammo_box/a357/metalshock

/datum/uplink_item/nt/ammo/revolver/heartpiercer
	name = ".357 Heartpiercer Speed Loader"
	desc = "A speed loader that contains seven .357 Heartpiercer rounds; usable with the Mateba revolver. \
			These rounds are less damaging, but penetrate through armor and up to two bodies at once."
	item = /obj/item/ammo_box/a357/heartpiercer

/datum/uplink_item/nt/ammo/revolver/wallstake
	name = ".357 Wallstake Speed Loader"
	desc = "A speed loader that contains seven .357 Wallstake rounds; usable with the Mateba revolver. \
			These blunt rounds are slightly less damaging but can knock people against walls."
	item = /obj/item/ammo_box/a357/wallstake
...
/datum/uplink_item/nt/cqc/combatglovesplus
	name = "Combat Gloves Plus"
	desc = "A pair of gloves that are fireproof and shock resistant, however unlike the regular Combat Gloves this one uses nanotechnology \
			to learn the abilities of krav maga to the wearer."
	item = /obj/item/clothing/gloves/krav_maga/combatglovesplus
...
/datum/uplink_item/nt/cqc/esword
	...
	item = /obj/item/melee/transforming/energy/sword/saber/blue
	cost = 8
...
/datum/uplink_item/nt/support/suppressor
	name = "Suppressor"
	desc = "This suppressor will silence the shots of the weapon it is attached to for increased stealth and superior ambushing capability. \
			It is compatible with many small ballistic guns, but not revolvers or energy guns."
	item = /obj/item/suppressor
	cost = 1
...
/datum/uplink_item/nt/support/holster
	name = "Holster"
	desc = "This holster can contain small gun and two quickloaders."
...
/datum/uplink_item/nt/gear/bowman
	name = "Bowman Headset"
	desc = "A headset specially issued to protect your ears from any damage, including flashbangs."
	item = /obj/item/radio/headset/headset_cent/alt
	cost = 1
