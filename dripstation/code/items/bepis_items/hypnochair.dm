...
/obj/machinery/hypnochair
	...
	icon = 'dripstation/icons/obj/hypnochair.dmi'
	icon_state = "hypnochair"
	var/base_icon_state = "hypnochair"
	...
	if(!(victim.get_eye_protection() > 0))
		...
		switch(time_diff)
			...
			if(201 to INFINITY)
				...
				victim.blur_eyes(300)
				if(prob(65))
					victim.apply_status_effect(/datum/status_effect/trance, rand(50,150), FALSE)
	victim = null

/obj/machinery/hypnochair/proc/update_icon_state()
