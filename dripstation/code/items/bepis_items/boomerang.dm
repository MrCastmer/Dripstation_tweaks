...
/obj/item/melee/baton/boomerang
	...
	throw_speed = 2
	icon = 'dripstation/icons/obj/weapons/security.dmi'
	lefthand_file = 'dripstation/icons/mob/inhands/security_lefthand.dmi'
	righthand_file = 'dripstation/icons/mob/inhands/security_righthand.dmi'
